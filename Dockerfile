...
COPY . .
RUN if [ ! -f /app/dsm2/tokenizer.json ] && [ -f /app/models/FastPLMs/e1_fastplms/tokenizer.json ]; then cp /app/models/FastPLMs/e1_fastplms/tokenizer.json /app/dsm2/tokenizer.json; fi
