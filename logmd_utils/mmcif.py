# From https://github.com/yehlincho/BoltzDesign1/blob/main/boltz/scripts/process/mmcif.py#L30
...
from logmd_utils.const import const
from logmd_utils.types import (
    Atom,
    Bond,
    Chain,
    Connection,
