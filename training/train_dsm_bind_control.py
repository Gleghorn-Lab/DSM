...
def parse_args():
    ...
    parser.add_argument("--save_path", type=str, default="lhallee/dsm_bind_150_control", help="Path to save the model and report to wandb")
